...
public class RolePermissionsController: ControllerBase
{
    ...
    [Authorize(Policy = Permissions.CanReadRolePermissions)]
    ...
    {
        var query = new GetRolePermissionList.RolePermissionListQuery(rolePermissionParametersDto);
    ...
    {
        var query = new GetRolePermission.RolePermissionQuery(id);
        var queryResponse = await _mediator.Send(query);
    ...
    [ProducesResponseType(403)]
    [ProducesResponseType(500)]
    [Authorize(Policy = Permissions.CanAddRolePermission)]
    ...
    {
        var command = new AddRolePermission.AddRolePermissionCommand(rolePermissionForCreation);
    ...
    [ProducesResponseType(403)]
    [ProducesResponseType(500)]
    [Authorize(Policy = Permissions.CanUpdateRolePermission)]
    [Produces("application/json")]
    ...
    {
        var command = new UpdateRolePermission.UpdateRolePermissionCommand(id, rolePermission);
    ...
    [ProducesResponseType(403)]
    [ProducesResponseType(500)]
    [Authorize(Policy = Permissions.CanDeleteRolePermission)]
    [Produces("application/json")]
